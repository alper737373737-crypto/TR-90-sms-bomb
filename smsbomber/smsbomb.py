...
╚██████╗██║  ██║███████╗   ██║   ██╔╝ ██╗███████╗    ███████║██║ ╚═╝ ██║███████║
 ╚═════╝╚═╝  ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝╚══════╝    ╚══════╝╚═╝     ╚═╝╚══════╝  sunar....
    ...
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " \n\n 2- SMS PRO \n\n \n\n" + Fore.LIGHTYELLOW_EX + " GİR -): "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Hatalı giriş düzgün yaz aptal")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "numara gir (5*********): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
        ...
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "NUMARA GİRİŞİ (5*********): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Hatalı numara tekrar deneyiniz") 
            sleep(3)
            continue
        system("cls||clear")
        try:
